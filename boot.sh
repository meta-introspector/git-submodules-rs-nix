...
~/pick-up-nix/result/bin/asciinema rec "$ASCIINEMA_REC_FILE" --command "/data/data/com.termux.nix/files/home/pick-up-nix/run_boot.sh \"$ASCIINEMA_REC_FILE\" \"$SESSION_NAME\" && /data/data/com.termux.nix/files/home/pick-up-nix/source/github/meta-introspector/submodules/launch_emacs_split.sh \"$SESSION_NAME\""
